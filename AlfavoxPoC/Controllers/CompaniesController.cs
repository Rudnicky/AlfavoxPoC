...
namespace AlfavoxPoC.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CompanyId,Name,Id")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CompanyId,Name,Id")] Company company)
        {
            if (id != company.Id)
            {
                return NotFound();
        ...
        {
            return _context.Compenies.Any(e => e.Id == id);
        }
    }
}
